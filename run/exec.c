...
/*   Updated: 2024/09/23 11:44:16 by mkadri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_path(t_cmd *cmd_node, t_env_node **env_list)
{
	...
	while (allpaths[++i])
	{
		...
		goodpath = ft_strjoin(subpath, cmd_node->name);
		free(subpath);
